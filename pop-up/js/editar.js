      bioEp.init({
            ...
            '</div>',
            css: '#bio_ep {width: 400px; height: 400px; color: #333; background-color: #fafafa; text-align: center;background-image: url(pop-up/imagens-pop/sorteio04.png);background-size: cover;}' +
